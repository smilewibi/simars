...
<section id="intro" class="intro">
	...
	<div class="container">
		...
		<div class="col-lg-6">
			...
			<img src="<?php echo Yii::app()->request->baseUrl; ?>/themesassets/img/dummy/img-1.png" class="img-responsive" alt="" />
			</div>
		</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="callaction bg-gray">
				...
				<div class="col-md-4">
					...
					<div class="cta-btn">
						<a href="index.php?r=site/contact" class="btn btn-skin btn-lg">Pesan Layanan Sekarang</a>
					</div>
					</div>
				</div>
				</div>
